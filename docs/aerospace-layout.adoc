...
* Change both tiling layout and orientation in one go: `h_tiles|v_tiles|h_accordion|v_accordion|h_scroll|v_scroll`
* Change tiling layout: `tiles|accordion|scroll`
