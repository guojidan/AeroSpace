...
== workspace-overview
----
include::aerospace-workspace-overview.adoc[tags=synopsis]
----
include::aerospace-workspace-overview.adoc[tags=purpose]
include::aerospace-workspace-overview.adoc[tags=body]
